...
public class AppException extends Exception implements UncaughtExceptionHandler {
	...
	private static final String HTTP_STATUS_CODE_ERROR = "网络异常，错误码：%d";

	private static final String HTTP_EXCEPTION_ERROR = "网络异常，请求超时";

	private static final String SOCKET_EXCEPTION_ERROR = "网络异常，读取数据超时";

	private static final String NETWORK_NOT_CONNECTED = "网络连接失败，请检查网络设置";

	private static final String XML_PARSER_FAILED = "数据解析异常";

	private static final String IO_EXCEPTION_ERROR = "文件流异常";

	private static final String APP_RUN_CODE_ERROR = "应用程序运行时异常";
